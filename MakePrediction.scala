...
object MakePrediction {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = spark
      .readStream
      .format("kafka")
      .option("kafka.bootstrap.servers", "practica_big_data_2019_kafka-server_1:9092")
    ...
    val writeConfig = WriteConfig(Map("uri" -> "mongodb://practica_big_data_2019_mongo_1:27017/agile_data_science.flight_delay_classification_response"))
