...
client = MongoClient('mongodb://practica_big_data_2019_mongo_1:27017')
...
producer = KafkaProducer(bootstrap_servers=['practica_big_data_2019_kafka-server_1:9092'],api_version=(0,10))
